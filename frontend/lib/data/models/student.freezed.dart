...
mixin _$Student {
 ...
 int get id; String get name; bool get isActive; int get dutyScore;
...
@useResult
$Res call({
 int id, String name, bool isActive, int dutyScore
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  bool isActive,  int dutyScore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Student() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  bool isActive,  int dutyScore)  $default,) {final _that = this;
switch (_that) {
case _Student():
return $default(_that.id,_that.name,_that.isActive,_that.dutyScore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  bool isActive,  int dutyScore)?  $default,) {final _that = this;
switch (_that) {
case _Student() when $default != null:
return $default(_that.id,_that.name,_that.isActive,_that.dutyScore);case _:
  return null;
...
class _Student implements Student {
  const _Student({required this.id, required this.name, this.isActive = true, this.dutyScore = 0});
  factory _Student.fromJson(Map<String, dynamic> json) => _$StudentFromJson(json);

@override final  int id;
@override final  String name;
@override@JsonKey() final  bool isActive;
@override@JsonKey() final  int dutyScore;
